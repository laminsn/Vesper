...
export const integrations: readonly Integration[] = [
  ...
  // ── AI Search ───────────────────────────────────
  {
    id: "cloudinary",
    name: "Cloudinary",
    description: "Media asset management — image and video upload, transformation, optimization, and delivery at scale",
    category: "cloud",
    tier: "professional",
    icon: "cloud",
    color: "#3448c5",
    features: ["Image optimization", "Video transcoding", "AI-powered transformations", "CDN delivery", "DAM", "Auto-tagging", "Background removal", "Responsive images"],
    connectionUrl: "https://cloudinary.com",
    defaultMethod: "api",
    supportedMethods: ["api", "cli", "browser"],
    credentialFields: [
  ...
  },
  {
    id: "remotion",
    name: "Remotion",
    description: "Programmatic video production — create videos with React, render at scale, build video pipelines",
    category: "video",
    tier: "professional",
    icon: "clapperboard",
    color: "#0b84f3",
    features: ["React-based video", "Server-side rendering", "Lambda rendering", "Audio sync", "Custom components", "Timeline editor", "GIF export", "Batch rendering"],
    connectionUrl: "https://remotion.dev",
    defaultMethod: "cli",
    supportedMethods: ["cli", "api", "manual"],
    credentialFields: [
      { key: "licenseKey", label: "License Key", type: "password", placeholder: "remotion-...", required: false },
    ],
  },
  {
    id: "ideogram",
    name: "Ideogram",
    description: "AI image generation with best-in-class text rendering for marketing visuals, social content, and brand assets",
    category: "llm",
    tier: "professional",
    icon: "image",
    color: "#1a1a2e",
    features: ["Text-in-image generation", "Style control", "Magic Prompt", "Aspect ratio control", "Upscaling", "Batch generation", "Brand consistency", "Commercial license"],
    connectionUrl: "https://ideogram.ai",
    defaultMethod: "api",
    supportedMethods: ["api", "browser", "manual"],
    credentialFields: [
      { key: "apiKey", label: "API Key", type: "password", required: true },
